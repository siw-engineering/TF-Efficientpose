...
#obj = '/home/pc/EfficientPose/untitled06.ply'
...
dist_coeff = np.array([0.007256425, -0.01652222, -0.002632064,  0.00306624,  0.00129971])
...
while True:
    ...
    raw_image = draw_detections(raw_image, image_boxes, image_scores, image_labels, image_rotations, image_translations,
                                ...
                                camera_matrix=camera_matrix, label_to_name=label_to_name, plydata=plydata, distCoeffs=dist_coeff)
